...
import 'package:app_spotify/common/widgets/button/basic_app_button.dart';
...
import 'package:app_spotify/presentation/auth/pages/signup.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            OutlinedButton(
              ...
              onPressed: () async {
                try {
                 final data = await FireAuthQuick.loginWithProvider(oAuth: OAuth.google);
